...
class TestIntJoukko(unittest.TestCase):
    def setUp(self):
        ...
        self.joukko.lisaa_alkio_listaan(10)
        self.joukko.lisaa_alkio_listaan(3)

    def tee_joukko(self, *luvut):
        joukko = IntJoukko()

        for luku in luvut:
            joukko.lisaa_alkio_listaan(luku)
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertEqual(joukko.listan_alkioiden_lukumaara(), 14)
        self.assertTrue(joukko.kuuluuko_alkio_listaan(11))
        joukko.poista_alkio_listasta(11)
        self.assertFalse(joukko.kuuluuko_alkio_listaan(11))
        self.assertEqual(joukko.listan_alkioiden_lukumaara(), 13)

    def test_lukuja_lisatty_maara(self):
        self.joukko.lisaa_alkio_listaan(4)
        self.assertEqual(self.joukko.listan_alkioiden_lukumaara(), 3)

    def test_sama_luku_menee_joukkoon_vaan_kerran(self):
        self.joukko.lisaa_alkio_listaan(10)
        self.joukko.lisaa_alkio_listaan(3)
        self.assertEqual(self.joukko.listan_alkioiden_lukumaara(), 2)

    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.kuuluuko_alkio_listaan(10))
        self.assertFalse(self.joukko.kuuluuko_alkio_listaan(5))
        self.assertTrue(self.joukko.kuuluuko_alkio_listaan(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista_alkio_listasta(3)
        self.assertFalse(self.joukko.kuuluuko_alkio_listaan(3))
        self.assertEqual(self.joukko.listan_alkioiden_lukumaara(), 1)

    def test_palautetaan_oikea_taulukko(self):
        odotettu = [3, 55, 99]

        self.joukko.lisaa_alkio_listaan(55)
        self.joukko.poista_alkio_listasta(10)
        self.joukko.lisaa_alkio_listaan(99)
